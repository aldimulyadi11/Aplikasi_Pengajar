...
<head>
  ...
  <!-- Favicons -->
  <link href="/asset1/img/favicon.png" rel="icon">
      ...
      <form class="form-login" method="POST" action="{{ route('user.loginPost') }}">
        ...
        <div class="login-wrap">
          ...
          <input type="password" class="form-control" name="password" placeholder="Password">
            ...
            <a data-toggle="modal" href="/asset1/login.html#myModal"> Forgot Password?</a>
            </span>
            </label>
          <button class="btn btn-theme btn-block" href="/asset1/index.html" type="submit"><i class="fa fa-lock"></i> SIGN IN</button>
          <hr>          
        </div>
      </form>
    </div>
