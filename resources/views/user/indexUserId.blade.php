...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav nav ml-auto">           
          ...
          <li class="nav-item"><a href="{{ route('pengajar.profile') }}" class="nav-link"><span>Profile</span></a></li> 
          <li class="nav-item"><a href="{{ route('user.changePassword') }}" class="nav-link"><span>Change Account</span></a></li>          
  ...
  <section class="home-slider js-fullheight owl-carousel" id="home">
    <div class="slider-item js-fullheight" style="background-image:url(/asset2/images/4.jpg);">
    ...
    <div class="container">
      <div class="row justify-content-center pb-5">
        <div class="col-md-12 heading-section text-center ftco-animate">
          ...
          <p>KU ini dibuat dengan tujuan untuk membuka lapangan pekerjaan bagi para pengajar</p>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="row block-9">
          <div class="col-md-7 order-md-last d-flex">
            <form action="{{ route('pesan.store2') }}" method="POST" class="bg-light p-4 p-md-5 contact-form">
