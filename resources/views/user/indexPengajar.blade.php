...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <section class="home-slider js-fullheight owl-carousel" id="home">
    <div class="slider-item js-fullheight" style="background-image:url(/asset2/images/8.jpg);">
        ...
        <div class="container">
          <div class="row justify-content-center pb-5">
            <div class="col-md-6 heading-section text-center ftco-animate">
              ...
              <h2 class="mb-4">Pengajar</h2>
            </div>
          </div>
          <div class="row">
            @foreach($pengajar2 as $pengajars)
            <div class="col-md-6 col-lg-3 ftco-animate">
              <div class="staff">
                <div class="text d-flex align-items-center pt-1 text-center">
                  <div class="img align-self-stretch"><img width="85%" height="70%" src="{{url("pribadi/pengajar")}}/{{($pengajars->foto_pribadi) }}"></div>

                </div>
                <div class="text d-flex align-items-center pt-1 text-center">
                  <div>
                    <h3 class="mb-1">{{ $pengajars->nama_lengkap }}</h3>                
                    <div class="faded">
