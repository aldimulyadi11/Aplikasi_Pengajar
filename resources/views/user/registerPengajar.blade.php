    ...
    <div class="container">
      <div class="row justify-content-center mb-5 pb-3">
        <div class="col-md-7 heading-section text-center ftco-animate">
          ...
          <h2 class="mb-4">Registrasi Pengajar</h2>            
        </div>
      </div>
      ...
      <div class="row block-9">
        <div class="col-md-12 order-md-last d-flex">
          <form action="{{ route('user.store') }}" class="bg-light p-4 p-md-5 contact-form" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label class="col-lg-12 control-label">Nama Panggilan <span class="form-required">*</span></label>
              <input type="text" class="form-control" name="nama_panggilan">
            </div>
            <div class="form-group">
              <label class="col-lg-12 control-label">Email <span class="form-required">*</span></label>
              <input type="email" class="form-control" name="email_pengajar">
            </div>
            <div class="form-group">
              <label class="col-lg-12 control-label">No. Hp <span class="form-required">*</span></label>
              <input type="number" class="form-control" name="no_hp">
            </div>
            <div class="form-group">
              <label class="col-lg-12 control-label">Kode Pos <span class="form-required">*</span></label>
              <input type="number" class="form-control" name="kode_pos">
            </div>
            <div class="form-group">
              <label class="col-lg-12 control-label">Pendidikan Terakhir<span class="form-required">*</span></label>
            ...
            <div class="form-group">
              ...
              <textarea cols="30" rows="7" class="form-control" name="alamat_lengkap"></textarea>
            </div>
            <div class="form-group">
              <label class="col-lg-12 control-label">Aktivitas <span class="form-required">*</span></label>
              <textarea cols="30" rows="7" class="form-control" name="aktivitas"></textarea>
            </div>
            <div class="form-group">
              <label class="col-lg-12 control-label">Ceritakan Diri<span class="form-required">*</span></label>
              <textarea cols="30" rows="7" class="form-control" name="ceritakan_diri"></textarea>
            </div>

            <div class="form-group">              
              <label class="control-label col-md">Materi <span class="form-required">*</span></label>
              <select name="id_materi" class="form-control" id="id_materi">
            ...
            <div class="form-group">              
              <label class="control-label col-md">Foto Pribadi <span class="form-required">*</span></label>
              <input type="file" class="form-control" name="foto_pribadi">
            </div>

            <div class="form-group">              
              <label class="control-label col-md">Foto KTP <span class="form-required">*</span></label>
              <input type="file" class="form-control" name="foto_ktp">
            </div>

            <div class="form-group">              
              <label class="control-label col-md">Foto Ijazah <span class="form-required">*</span></label>
              <input type="file" class="form-control" name="foto_ijazah">
            </div>

            <div class="form-group">              
              <label class="control-label col-md">Foto Sertifikat / Pelatihan <span class="form-required">*</span></label>
